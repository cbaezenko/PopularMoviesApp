...
public class FavoriteMovieDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        final String SQL_CREATE_FAVORITE_MOVIE_TABLE = "CREATE TABLE " +
                ...
                FavoriteMovieContract.FavoriteMovie.COLUMN_USER_RATING + " DOUBLE NOT NULL, " +
                FavoriteMovieContract.FavoriteMovie.COLUMN_RUNTIME + " INTEGER NOT NULL, " +
                FavoriteMovieContract.FavoriteMovie.COLUMN_MOVIE_OVERVIEW + " TEXT NOT NULL, "+
                FavoriteMovieContract.FavoriteMovie.COLUMN_MOVIE_BACKDROP_IMAGE + " TEXT NOT NULL"+
                ");";
